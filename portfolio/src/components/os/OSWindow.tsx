...
export default function OSWindow({
  ...
  return (
    ...
    >
      <div
        className={`flex min-h-11 shrink-0 items-center justify-between gap-3 border-b border-slate-200/80 bg-gradient-to-b from-white/95 to-slate-100/[0.92] px-4 py-2.5 dark:border-slate-800/90 dark:from-slate-900/95 dark:to-slate-950/[0.92] ${titleBarClassName}`}
      >
