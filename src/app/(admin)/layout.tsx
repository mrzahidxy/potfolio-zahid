...
export default function RootLayout({
  ...
  return (
    ...
    >
      <aside className={`hidden w-64 flex-col border-r px-5 py-6 shadow-xl backdrop-blur lg:flex ${
        ...
        <div className="mb-8 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-lg font-semibold">{isDarkMode ? "Zahid Hasan" : "Zahid Hasan"}</p>
          </div>
        </div>
      ...
      <div className="flex-1">
        <header className={`flex items-center justify-between border-b px-4 py-4 shadow-sm backdrop-blur ${
          isDarkMode ? "border-slate-800 bg-slate-900/70" : "border-slate-200 bg-white/80"
        }`}>
          <div>
            <p className={`text-xs uppercase tracking-[0.3em] ${isDarkMode ? "text-slate-500" : "text-slate-500"}`}>
              Admin
            </p>
            <h1 className={`text-xl font-semibold ${isDarkMode ? "text-white" : "text-slate-900"}`}>{activeTitle}</h1>
          </div>
          <div className="flex items-center gap-3">
            ...
            <div className={`flex items-center gap-2 rounded-full border px-3 py-1.5 text-sm shadow-inner ${
              isDarkMode
